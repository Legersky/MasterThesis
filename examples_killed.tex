...
\multicolumn{2}{l}{\begin{minipage}{0.97\textwidth} Computation of Phase 2 (method  21) was interrupted. % when the length of window 1 was being processed. Numbers of saved combinations for each finished length are: ()
\end{minipage} }\\
\end{tabular}
