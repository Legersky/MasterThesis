...
\multicolumn{2}{l}{\begin{minipage}{\textwidth} Computation of Phase 2 (method  21) was killed. % when the length of window 1 was being proccessed. Numbers of saved combinations for each finished length of window are: []
\end{minipage} }\\
\end{tabular}
