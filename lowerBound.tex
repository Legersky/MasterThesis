...
If $n=0$, $x'=a_0$. Now we use the fact, that if there is an parallel addition algorithm, for each letter $b \in\A+\A$, there is $a\in\A$ such that $b \equiv_{\beta-1} a$. For $n+1$, we have
\begin{align*}
