...
We  recalled necessary definitions and notation. The concept of parallel addition and extending  window method was explained. We proposed various methods for both phase. Some of them involved $\beta$-norm, which was constructed by using the companion matrix of the minimal polynomial $m_\beta$.
...
The check convergence of Phase~2 for $bb\dots b$ inputs was reviewed. Next, we introduced the notion of a Rauzy graph of Phase~2. We proved Theorem~\ref{thm:infinitePathInRauzyGraph} which provides control of non-convergence of Phase~2 by searching for a cycle in the Rauzy graph.
