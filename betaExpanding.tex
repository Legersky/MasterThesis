...
\komentar{A[beta] neni definovane}    Let $\omega$ be a complex number and $\beta \in\Zomega$ be such that $|\beta|>1$. Let $\A\subset \Zomega$ be an alphabet. If $\NN\subset \A[\beta]$, the number $\beta$ is expanding.
\end{thm}
\begin{proof}
